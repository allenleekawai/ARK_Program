...
def Repair():
    ...
    """ 點擊修理工具 """
    pressMouse(1542, 700, 0.3)
    time.sleep(randomDelay(0.3, 0.4))
    """ 點擊修理全部 """
    pressMouse(1040, 805, 0.3)
    time.sleep(randomDelay(0.3, 0.4))
    """ 確認修理 """
    pressKey("enter")
    time.sleep(randomDelay(1.0, 1.5))
    """ 點擊退出 """
    pressMouse(2432, 1026, 0.3)
    time.sleep(randomDelay(1.5, 2.0))
    """ 關閉寵物界面 """
    pressMouse(1627, 207, 0.3)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        """ 按A拋竿 """
        print("---------- Reload ----------")
        pyautogui.moveTo(1584, 227, duration=randomDelay(0.2, 0.3), tween=pyautogui.easeInOutQuad) # 移到水中
